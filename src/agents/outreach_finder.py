...
class OutreachFinderAgent:
    ...
    def _mock_google_search(self, query: str):
        ...
        if "VP" in query or "Manager" in query:
            return [{"title": "Alice Smith - VP Engineering at MockCorp - LinkedIn", "link": "https://linkedin.com/in/alicesmith"}]
        return [{"title": "Bob Jones - Recruiter at MockCorp - LinkedIn", "link": "https://linkedin.com/in/bobjones"}]
